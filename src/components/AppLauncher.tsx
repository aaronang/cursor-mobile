    ...
    <div className="min-h-screen p-4 bg-stone-50">
      ...
      <div className="grid grid-cols-3 gap-6 max-w-sm mx-auto pt-20">
        {apps.map((app) => (
          ...
          >
            <div className="w-16 h-16 bg-stone-900 rounded-2xl flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow border border-stone-50/10">
              {app.icon}
            </div>
